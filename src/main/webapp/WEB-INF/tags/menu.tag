		...
		<div class="navbar-collapse collapse" id="main-navbar">
			<ul class="nav navbar-nav">
				...
				<petclinic:menuItem active="${name eq 'home'}" url="/"
					...
					<span><fmt:message key="label.menu.home"/></span>
				...
				<petclinic:menuItem active="${name eq 'owners'}" url="/owners/find"
					...
					<span><fmt:message key="label.menu.findOwners"/></span>
				</petclinic:menuItem>

				<petclinic:menuItem active="${name eq 'vets'}" url="/vets"
					title="veterinarians">
					<span class="glyphicon glyphicon-th-list" aria-hidden="true"></span>
					<span><fmt:message key="label.menu.veterinarians"/></span>
				</petclinic:menuItem>
			...
			<ul class="nav navbar-nav navbar-right">
				<sec:authorize access="!isAuthenticated()">
					<li><a href="<c:url value="/login" />"><fmt:message key="label.menu.login"/></a></li>
					<li><a href="<c:url value="/users/new" />"><fmt:message key="label.menu.register"/></a></li>
				</sec:authorize>
				<sec:authorize access="isAuthenticated()">
